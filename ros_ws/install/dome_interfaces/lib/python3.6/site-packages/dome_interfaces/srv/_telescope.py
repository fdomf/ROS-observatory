...
class Metaclass_Telescope(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dome_interfaces.srv import _telescope
...
class Telescope(metaclass=Metaclass_Telescope):
    from dome_interfaces.srv._telescope import Telescope_Request as Request
    from dome_interfaces.srv._telescope import Telescope_Response as Response
