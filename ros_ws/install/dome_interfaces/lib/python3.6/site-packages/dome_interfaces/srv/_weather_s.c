...
bool dome_interfaces__srv__weather__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "dome_interfaces.srv._weather.Weather_Request",
        full_classname_dest, 44) == 0);
  }
  dome_interfaces__srv__Weather_Request * ros_message = _ros_message;
  {  // weather_action
...
PyObject * dome_interfaces__srv__weather__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dome_interfaces.srv._weather");
...
ROSIDL_GENERATOR_C_EXPORT
bool dome_interfaces__srv__weather__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "dome_interfaces.srv._weather.Weather_Response",
        full_classname_dest, 45) == 0);
  }
  dome_interfaces__srv__Weather_Response * ros_message = _ros_message;
  {  // data_response
