...
#include <stddef.h>
#include "dome_interfaces/srv/telescope__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Telescope_Request__rosidl_typesupport_introspection_c__Telescope_Request_message_member_array[3] = {
  {
    ...
    offsetof(dome_interfaces__srv__Telescope_Request, telescope_action),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dome_interfaces__srv__Telescope_Request, alt),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dome_interfaces__srv__Telescope_Request, az),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Telescope_Request__rosidl_typesupport_introspection_c__Telescope_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(dome_interfaces__srv__Telescope_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Telescope_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember Telescope_Response__rosidl_typesupport_introspection_c__Telescope_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dome_interfaces__srv__Telescope_Response, telescope_response),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Telescope_Response__rosidl_typesupport_introspection_c__Telescope_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(dome_interfaces__srv__Telescope_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_dome_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Telescope_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_service_members = {
  "dome_interfaces__srv",  // service namespace
  "Telescope",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_Request_message_type_support_handle,
  NULL  // response message
  // dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_Response_message_type_support_handle
};

static rosidl_service_type_support_t dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_service_type_support_handle = {
  0,
  &dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Telescope)() {
  if (!dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_service_type_support_handle.typesupport_identifier) {
    dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Telescope_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Telescope_Response)()->data;
  }

  return &dome_interfaces__srv__telescope__rosidl_typesupport_introspection_c__Telescope_service_type_support_handle;
}
