...
class Metaclass_Dome(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'observatory_interfaces.srv.Dome')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from observatory_interfaces.srv import _dome
...
class Dome(metaclass=Metaclass_Dome):
    from observatory_interfaces.srv._dome import Dome_Request as Request
    from observatory_interfaces.srv._dome import Dome_Response as Response
