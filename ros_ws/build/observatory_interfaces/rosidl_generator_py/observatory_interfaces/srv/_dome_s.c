...
bool observatory_interfaces__srv__dome__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "observatory_interfaces.srv._dome.Dome_Request",
        full_classname_dest, 45) == 0);
  }
  observatory_interfaces__srv__Dome_Request * ros_message = _ros_message;
  {  // dome_action
...
PyObject * observatory_interfaces__srv__dome__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("observatory_interfaces.srv._dome");
...
ROSIDL_GENERATOR_C_EXPORT
bool observatory_interfaces__srv__dome__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "observatory_interfaces.srv._dome.Dome_Response",
        full_classname_dest, 46) == 0);
  }
  observatory_interfaces__srv__Dome_Response * ros_message = _ros_message;
  {  // dome_response
