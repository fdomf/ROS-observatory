...
class Metaclass_Weather(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'observatory_interfaces.srv.Weather')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from observatory_interfaces.srv import _weather
...
class Weather(metaclass=Metaclass_Weather):
    from observatory_interfaces.srv._weather import Weather_Request as Request
    from observatory_interfaces.srv._weather import Weather_Response as Response
