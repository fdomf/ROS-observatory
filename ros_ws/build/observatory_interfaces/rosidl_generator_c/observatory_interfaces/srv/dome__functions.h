...
#ifndef OBSERVATORY_INTERFACES__SRV__DOME__FUNCTIONS_H_
#define OBSERVATORY_INTERFACES__SRV__DOME__FUNCTIONS_H_
 ...
 * calls
 * observatory_interfaces__srv__Dome_Request__init().
...
/**
 * It calls
 * observatory_interfaces__srv__Dome_Request__fini()
 ...
 * observatory_interfaces__srv__Dome_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * observatory_interfaces__srv__Dome_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * observatory_interfaces__srv__Dome_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_observatory_interfaces
...
/**
 * It calls
 * observatory_interfaces__srv__Dome_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_observatory_interfaces
...
/**
 * It allocates the memory for the array and calls
 * observatory_interfaces__srv__Dome_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_observatory_interfaces
...
/**
 * It calls
 * observatory_interfaces__srv__Dome_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OBSERVATORY_INTERFACES__SRV__DOME__FUNCTIONS_H_
