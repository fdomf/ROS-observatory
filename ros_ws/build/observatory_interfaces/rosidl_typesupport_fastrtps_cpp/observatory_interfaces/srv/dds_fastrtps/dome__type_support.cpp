...
#include "observatory_interfaces/srv/dome__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const observatory_interfaces::srv::Dome_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<observatory_interfaces::srv::Dome_Request *>(
    untyped_ros_message);
...
{
  return &observatory_interfaces::srv::typesupport_fastrtps_cpp::_Dome_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const observatory_interfaces::srv::Dome_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<observatory_interfaces::srv::Dome_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &observatory_interfaces::srv::typesupport_fastrtps_cpp::_Dome_Response__handle;
}
...
{
  return &observatory_interfaces::srv::typesupport_fastrtps_cpp::_Dome__handle;
}
