...
#include "observatory_interfaces/srv/weather__rosidl_typesupport_fastrtps_c.h"
...
using _Weather_Request__ros_msg_type = observatory_interfaces__srv__Weather_Request;
...
size_t get_serialized_size_observatory_interfaces__srv__Weather_Request(
  const void * untyped_ros_message,
...
static uint32_t _Weather_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_observatory_interfaces__srv__Weather_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_observatory_interfaces
size_t max_serialized_size_observatory_interfaces__srv__Weather_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_observatory_interfaces__srv__Weather_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, observatory_interfaces, srv, Weather_Request)() {
...
using _Weather_Response__ros_msg_type = observatory_interfaces__srv__Weather_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_observatory_interfaces
size_t get_serialized_size_observatory_interfaces__srv__Weather_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Weather_Response__ros_msg_type * ros_message = static_cast<const _Weather_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_observatory_interfaces__srv__Weather_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_observatory_interfaces
size_t max_serialized_size_observatory_interfaces__srv__Weather_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_observatory_interfaces__srv__Weather_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, observatory_interfaces, srv, Weather_Response)() {
...
// already included above
// #include "observatory_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "observatory_interfaces/srv/weather.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, observatory_interfaces, srv, Weather)() {
