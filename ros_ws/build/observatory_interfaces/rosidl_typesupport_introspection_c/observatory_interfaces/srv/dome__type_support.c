...
#include <stddef.h>
#include "observatory_interfaces/srv/dome__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Dome_Request__rosidl_typesupport_introspection_c__Dome_Request_message_member_array[1] = {
  {
    ...
    offsetof(observatory_interfaces__srv__Dome_Request, dome_action),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Dome_Request__rosidl_typesupport_introspection_c__Dome_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(observatory_interfaces__srv__Dome_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, observatory_interfaces, srv, Dome_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember Dome_Response__rosidl_typesupport_introspection_c__Dome_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(observatory_interfaces__srv__Dome_Response, dome_response),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Dome_Response__rosidl_typesupport_introspection_c__Dome_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(observatory_interfaces__srv__Dome_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_observatory_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, observatory_interfaces, srv, Dome_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_service_members = {
  "observatory_interfaces__srv",  // service namespace
  "Dome",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_Request_message_type_support_handle,
  NULL  // response message
  // observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_Response_message_type_support_handle
};

static rosidl_service_type_support_t observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_service_type_support_handle = {
  0,
  &observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, observatory_interfaces, srv, Dome)() {
  if (!observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_service_type_support_handle.typesupport_identifier) {
    observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, observatory_interfaces, srv, Dome_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, observatory_interfaces, srv, Dome_Response)()->data;
  }

  return &observatory_interfaces__srv__dome__rosidl_typesupport_introspection_c__Dome_service_type_support_handle;
}
