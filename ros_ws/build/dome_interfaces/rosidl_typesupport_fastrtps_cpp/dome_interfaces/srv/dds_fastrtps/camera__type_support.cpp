...
{
  auto typed_message =
    static_cast<const dome_interfaces::srv::Camera_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dome_interfaces::srv::Camera_Request *>(
    untyped_ros_message);
...
{
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Camera_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: camera_response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.camera_response[index].size() + 1);
    }
  }
...
{
  auto typed_message =
    static_cast<const dome_interfaces::srv::Camera_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dome_interfaces::srv::Camera_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Camera_Response__handle;
}
...
{
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Camera__handle;
}
