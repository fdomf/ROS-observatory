...
#include "dome_interfaces/srv/weather__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dome_interfaces::srv::Weather_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dome_interfaces::srv::Weather_Request & ros_message)
{
  // Member: weather_action
  cdr >> ros_message.weather_action;
...
{
  auto typed_message =
    static_cast<const dome_interfaces::srv::Weather_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dome_interfaces::srv::Weather_Request *>(
    untyped_ros_message);
...
{
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Weather_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dome_interfaces, srv, Weather_Request)() {
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Weather_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dome_interfaces
cdr_serialize(
  const dome_interfaces::srv::Weather_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dome_interfaces::srv::Weather_Response & ros_message)
{
  // Member: data_response
  {
    cdr >> ros_message.data_response;
...
{
  auto typed_message =
    static_cast<const dome_interfaces::srv::Weather_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dome_interfaces::srv::Weather_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Weather_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dome_interfaces, srv, Weather_Response)() {
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Weather_Response__handle;
}
...
{
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Weather__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dome_interfaces, srv, Weather)() {
  return &dome_interfaces::srv::typesupport_fastrtps_cpp::_Weather__handle;
}
