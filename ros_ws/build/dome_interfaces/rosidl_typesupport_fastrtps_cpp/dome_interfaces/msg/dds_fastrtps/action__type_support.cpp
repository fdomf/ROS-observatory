...
#include "dome_interfaces/msg/action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dome_interfaces::msg::Action & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dome_interfaces::msg::Action & ros_message)
{
  // Member: action
  cdr >> ros_message.action;
...
{
  auto typed_message =
    static_cast<const dome_interfaces::msg::Action *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dome_interfaces::msg::Action *>(
    untyped_ros_message);
...
get_message_type_support_handle<dome_interfaces::msg::Action>()
{
  return &dome_interfaces::msg::typesupport_fastrtps_cpp::_Action__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dome_interfaces, msg, Action)() {
  return &dome_interfaces::msg::typesupport_fastrtps_cpp::_Action__handle;
}
