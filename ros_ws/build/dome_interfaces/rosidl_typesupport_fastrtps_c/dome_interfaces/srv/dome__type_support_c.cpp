...
#include "dome_interfaces/srv/dome__rosidl_typesupport_fastrtps_c.h"
...
using _Dome_Request__ros_msg_type = dome_interfaces__srv__Dome_Request;
...
size_t get_serialized_size_dome_interfaces__srv__Dome_Request(
  const void * untyped_ros_message,
...
static uint32_t _Dome_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dome_interfaces__srv__Dome_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dome_interfaces
size_t max_serialized_size_dome_interfaces__srv__Dome_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dome_interfaces__srv__Dome_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dome_interfaces, srv, Dome_Request)() {
...
using _Dome_Response__ros_msg_type = dome_interfaces__srv__Dome_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dome_interfaces
size_t get_serialized_size_dome_interfaces__srv__Dome_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dome_Response__ros_msg_type * ros_message = static_cast<const _Dome_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dome_interfaces__srv__Dome_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dome_interfaces
size_t max_serialized_size_dome_interfaces__srv__Dome_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dome_interfaces__srv__Dome_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dome_interfaces, srv, Dome_Response)() {
...
// already included above
// #include "dome_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dome_interfaces/srv/dome.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dome_interfaces, srv, Dome)() {
  return &Dome__handle;
}
