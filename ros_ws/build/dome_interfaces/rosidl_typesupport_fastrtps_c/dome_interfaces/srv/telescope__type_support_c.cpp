...
#include "dome_interfaces/srv/telescope__rosidl_typesupport_fastrtps_c.h"
...
using _Telescope_Request__ros_msg_type = dome_interfaces__srv__Telescope_Request;
...
size_t get_serialized_size_dome_interfaces__srv__Telescope_Request(
  const void * untyped_ros_message,
...
static uint32_t _Telescope_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dome_interfaces__srv__Telescope_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dome_interfaces
size_t max_serialized_size_dome_interfaces__srv__Telescope_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dome_interfaces__srv__Telescope_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dome_interfaces, srv, Telescope_Request)() {
...
using _Telescope_Response__ros_msg_type = dome_interfaces__srv__Telescope_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dome_interfaces
size_t get_serialized_size_dome_interfaces__srv__Telescope_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Telescope_Response__ros_msg_type * ros_message = static_cast<const _Telescope_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dome_interfaces__srv__Telescope_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dome_interfaces
size_t max_serialized_size_dome_interfaces__srv__Telescope_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dome_interfaces__srv__Telescope_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dome_interfaces, srv, Telescope_Response)() {
...
// already included above
// #include "dome_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dome_interfaces/srv/telescope.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dome_interfaces, srv, Telescope)() {
