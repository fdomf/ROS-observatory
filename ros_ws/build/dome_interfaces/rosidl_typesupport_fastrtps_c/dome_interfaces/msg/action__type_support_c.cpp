...
#include "dome_interfaces/msg/action__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // action
#include "rosidl_generator_c/string_functions.h"  // action

// forward declare type support functions


using _Action__ros_msg_type = dome_interfaces__msg__Action;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: action
  {
    const rosidl_generator_c__String * str = &ros_message->action;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: action
  {
    ...
    if (!ros_message->action.data) {
      rosidl_generator_c__String__init(&ros_message->action);
    }
...
size_t get_serialized_size_dome_interfaces__msg__Action(
  const void * untyped_ros_message,
...
static uint32_t _Action__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dome_interfaces__msg__Action(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dome_interfaces
size_t max_serialized_size_dome_interfaces__msg__Action(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dome_interfaces__msg__Action(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dome_interfaces, msg, Action)() {
