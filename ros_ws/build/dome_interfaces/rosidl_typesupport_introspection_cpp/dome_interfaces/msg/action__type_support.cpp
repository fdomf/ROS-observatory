...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Action_message_member_array[1] = {
  {
    ...
    offsetof(dome_interfaces::msg::Action, action),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Action_message_members = {
  ...
  "Action",  // message name
  1,  // number of fields
  sizeof(dome_interfaces::msg::Action),
...
{
  return &::dome_interfaces::msg::rosidl_typesupport_introspection_cpp::Action_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dome_interfaces, msg, Action)() {
  return &::dome_interfaces::msg::rosidl_typesupport_introspection_cpp::Action_message_type_support_handle;
}
