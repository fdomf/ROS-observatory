...
bool dome_interfaces__srv__telescope__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "dome_interfaces.srv._telescope.Telescope_Request",
        full_classname_dest, 48) == 0);
  }
  dome_interfaces__srv__Telescope_Request * ros_message = _ros_message;
  {  // telescope_action
...
PyObject * dome_interfaces__srv__telescope__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dome_interfaces.srv._telescope");
...
ROSIDL_GENERATOR_C_EXPORT
bool dome_interfaces__srv__telescope__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "dome_interfaces.srv._telescope.Telescope_Response",
        full_classname_dest, 49) == 0);
  }
  dome_interfaces__srv__Telescope_Response * ros_message = _ros_message;
  {  // telescope_response
