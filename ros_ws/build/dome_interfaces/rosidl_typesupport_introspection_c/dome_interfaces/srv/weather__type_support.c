...
#include <stddef.h>
#include "dome_interfaces/srv/weather__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Weather_Request__rosidl_typesupport_introspection_c__Weather_Request_message_member_array[1] = {
  {
    ...
    offsetof(dome_interfaces__srv__Weather_Request, weather_action),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Weather_Request__rosidl_typesupport_introspection_c__Weather_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(dome_interfaces__srv__Weather_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Weather_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember Weather_Response__rosidl_typesupport_introspection_c__Weather_Response_message_member_array[1] = {
  {
    ...
    10,  // array size
    false,  // is upper bound
    offsetof(dome_interfaces__srv__Weather_Response, data_response),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Weather_Response__rosidl_typesupport_introspection_c__Weather_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(dome_interfaces__srv__Weather_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_dome_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Weather_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_service_members = {
  "dome_interfaces__srv",  // service namespace
  "Weather",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_Request_message_type_support_handle,
  NULL  // response message
  // dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_Response_message_type_support_handle
};

static rosidl_service_type_support_t dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_service_type_support_handle = {
  0,
  &dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Weather)() {
  if (!dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_service_type_support_handle.typesupport_identifier) {
    dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Weather_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dome_interfaces, srv, Weather_Response)()->data;
  }

  return &dome_interfaces__srv__weather__rosidl_typesupport_introspection_c__Weather_service_type_support_handle;
}
