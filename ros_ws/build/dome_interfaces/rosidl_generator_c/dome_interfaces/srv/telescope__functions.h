...
#ifndef DOME_INTERFACES__SRV__TELESCOPE__FUNCTIONS_H_
#define DOME_INTERFACES__SRV__TELESCOPE__FUNCTIONS_H_
 ...
 * calls
 * dome_interfaces__srv__Telescope_Request__init().
...
/**
 * It calls
 * dome_interfaces__srv__Telescope_Request__fini()
 ...
 * dome_interfaces__srv__Telescope_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dome_interfaces__srv__Telescope_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dome_interfaces__srv__Telescope_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dome_interfaces
...
/**
 * It calls
 * dome_interfaces__srv__Telescope_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dome_interfaces
...
/**
 * It allocates the memory for the array and calls
 * dome_interfaces__srv__Telescope_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dome_interfaces
...
/**
 * It calls
 * dome_interfaces__srv__Telescope_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DOME_INTERFACES__SRV__TELESCOPE__FUNCTIONS_H_
